...
import icon1 from "../../assets/certificates/12.svg";
import icon2 from "../../assets/certificates/7.svg";
import icon3 from "../../assets/certificates/8.svg";
import icon4 from "../../assets/certificates/9.svg";
import icon5 from "../../assets/certificates/3.svg";
import icon6 from "../../assets/certificates/10.svg";
import icon7 from "../../assets/certificates/11.svg";
          ...
          >
            <div className="col-lg-3 col-md-4 col-sm-6">
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <div className="img-position  mb-3">
                  <img src={icon1} alt="" className="w-25" />
                </div>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6">
              ...
              >
                <div className="img-position  mb-3">
                  <img src={icon2} alt="" className="w-25" />
                </div>
                <p className="text-center">
            ...
            <div className="col-lg-3 col-md-4 col-sm-6">
              ...
              >
                <div className="img-position  mb-3">
                  <img src={icon3} alt="" className="w-25" />
                </div>
                <p className="text-center">
            ...
            <div className="col-lg-3 col-md-4 col-sm-6">
              ...
              >
                <div className="img-position  mb-3">
                  <img src={icon4} alt="" className="w-25" />
                </div>
                <p className="text-center">
            ...
            <div className="col-lg-4 col-md-4 col-sm-6">
              ...
              >
                <div className="img-position  mb-3">
                  <img src={icon5} alt="" className="w-25" />
                </div>
                <p className="text-center">
            ...
            <div className="col-lg-4 col-md-4 col-sm-6">
              ...
              >
                <div className="img-position  mb-3">
                  <img src={icon6} alt="" className="w-25" />
                </div>
                <p className="text-center">
            ...
            <div className="col-lg-3 col-md-4 col-sm-6">
              ...
              >
                <div className="img-position  mb-3">
                  <img src={icon7} alt="" className="img-w" />
                </div>
                <p className="text-center">
